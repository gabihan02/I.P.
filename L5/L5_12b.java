// (b) O mes em que houve mais vendas na rede inteira
...
class L5_12b{
	...
	public static void main(String[] args){
		...
		System.out.println(MaisVendeu(vendas));
		
	}
	
	static double ValoresColuna(double[][] num, int col){
	...
	static double MaisVendeu(double[][] num){		
		int indiceMax = 0;
		double somaMaior = ValoresColuna(num, indiceMax);
		
		for (int i=0; i<num.length; i++){
			double somaAtual = ValoresColuna(num, i);
